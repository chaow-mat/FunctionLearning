...
# whiten the data
data_advec_input = data_advec_input - np.mean(data_advec_input, axis=1)[:,None]
data_advec_output = data_advec_output - np.mean(data_advec_output, axis=1)[:,None]


n_train = cfg.M  # N
# n_test = 40000 - n_train
n_test = cfg.M
X_train = data_advec_input[:, :n_train]
X_test = data_advec_input[:, n_train:n_train+n_test]
Y_train = data_advec_output[:, :n_train]
Y_test = data_advec_output[:, n_train:n_train+n_test]
X_train_flat = X_train # X
Y_train_flat = Y_train  # Y
X_test_flat = X_test  # \tilde{X}
Y_test_flat = Y_test  # \tilde{Y}
