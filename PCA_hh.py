...
inputs = data_hh_input
outputs = data_hh_output
...
path = "hh/PCA/PCA_hh_dpca" +str(cfg.dim_PCA) + '_cw' + str(cfg.width) + "Nd_" + str(ntrain) + '_lr_' + str(learning_rate) + '-' + str(
    step_size) + '-' + str(gamma)
...
for ep in range(epochs):
    ...
    if ep % 10 == 0:
        ...
        print(f"Average Relative Test Error PCA: {average_relative_error: .6e} {average_relative_error2: .6e}")
