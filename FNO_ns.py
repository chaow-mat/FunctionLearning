...
cs = np.load(prefix + "/NavierStokes_inputs.npy")
K = np.load(prefix + "/NavierStokes_outputs.npy")
...
path = "ns/FNO/FNO_"+str(width)+"Nd_"+str(ntrain)+"m_" +str(modes) + '_lr_' + str(learning_rate) + '-' + str(step_size) + '-' + str(gamma)
...
for ep in range(epochs):
    ...
    # torch.save(model, "FNO_"+str(width)+"Nd_"+str(ntrain)+"m_" +str(modes) + '_lr_' + str(learning_rate) + '-' + str(step_size) + '-' + str(gamma) + ".model")
    scheduler.step()
