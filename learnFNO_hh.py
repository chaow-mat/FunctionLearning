...
cs = np.load(prefix + "/Helmholtz_inputs.npy")
K = np.load(prefix + "/Helmholtz_outputs.npy")
...
path = "hh/FNO/FNO_hh_"+str(width)+"Nd_"+str(ntrain)+"m_" +str(modes) + '_lr_' + str(learning_rate) + '-' + str(step_size) + '-' + str(gamma)
